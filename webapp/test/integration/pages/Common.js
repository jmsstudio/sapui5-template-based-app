sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("br/com/jmsstudio/productsmanagement/ProductsManagement/app", ".html");
		...
		return Opa5.extend("br.com.jmsstudio.productsmanagement.ProductsManagement.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["br/com/jmsstudio/productsmanagement/ProductsManagement/localService/mockserver"], function (mockserver) {
